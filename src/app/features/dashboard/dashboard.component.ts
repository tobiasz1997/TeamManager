...
export class DashboardComponent {
  ...
  public increment() {
    this.indexOfArray = this.indexOfArray < this.arrayOfValues.length - 1 ? this.indexOfArray += 1 : 0;
  }

  public decrement() {
    this.indexOfArray = this.indexOfArray > 0 ? this.indexOfArray -= 1 : this.arrayOfValues.length - 1;
  }
